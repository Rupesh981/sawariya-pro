// Medical Tests & Health Packages Content
import type { MedicalTest, HealthPackage, TestCategoryItem } from "../types";
...
export const medicalTests: MedicalTest[] = [
  ...
  },
  {
    id: "serum-insulin",
    name: "Serum Insulin",
    description: "Essential test for detecting insulin levels.",
    price: 899,
    originalPrice: 1299,
    turnaroundTime: "8-10 hours",
    category: "specialized",
...
export const testCategories: TestCategoryItem[] = [
